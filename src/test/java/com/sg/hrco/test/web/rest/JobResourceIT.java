...
import com.sg.hrco.test.domain.Job;
import com.sg.hrco.test.repository.JobRepository;
...
public class JobResourceIT {
    ...
    private static final String DEFAULT_JOB_TITLE_A = "AAAAAAAAAA";
    private static final String UPDATED_JOB_TITLE_A = "BBBBBBBBBB";
    ...
    public void createJob() throws Exception {
        ...
        assertThat(testJob.getJobTitleA()).isEqualTo(DEFAULT_JOB_TITLE_A);
    ...
    public void getAllJobs() throws Exception {
        ...
        restJobMockMvc.perform(get("/api/jobs?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].jobTitleA").value(hasItem(DEFAULT_JOB_TITLE_A)))
    ...
    public void getJob() throws Exception {
        ...
        restJobMockMvc.perform(get("/api/jobs/{id}", job.getId()))
            ...
            .andExpect(jsonPath("$.jobTitleA").value(DEFAULT_JOB_TITLE_A))
    ...
    public void updateJob() throws Exception {
        ...
        assertThat(testJob.getJobTitleA()).isEqualTo(UPDATED_JOB_TITLE_A);
