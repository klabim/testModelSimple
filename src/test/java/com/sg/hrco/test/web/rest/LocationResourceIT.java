...
import com.sg.hrco.test.repository.LocationRepository;
import com.sg.hrco.test.service.LocationService;
...
public class LocationResourceIT {
    ...
    private static final String DEFAULT_STATE_M = "AAAAAAAAAA";
    private static final String UPDATED_STATE_M = "BBBBBBBBBB";
    ...
    public void createLocation() throws Exception {
        ...
        assertThat(testLocation.getStateM()).isEqualTo(DEFAULT_STATE_M);
    }
    ...
    public void getAllLocations() throws Exception {
        ...
        restLocationMockMvc.perform(get("/api/locations?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].stateM").value(hasItem(DEFAULT_STATE_M)));
    }
    ...
    public void getLocation() throws Exception {
        ...
        restLocationMockMvc.perform(get("/api/locations/{id}", location.getId()))
            ...
            .andExpect(jsonPath("$.stateM").value(DEFAULT_STATE_M));
    }
    ...
    public void updateLocation() throws Exception {
        ...
        assertThat(testLocation.getStateM()).isEqualTo(UPDATED_STATE_M);
    }
