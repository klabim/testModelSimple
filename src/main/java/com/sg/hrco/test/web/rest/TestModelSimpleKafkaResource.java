...
@RestController
@RequestMapping("/api/test-model-simple-kafka")
public class TestModelSimpleKafkaResource {
    private final Logger log = LoggerFactory.getLogger(TestModelSimpleKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public TestModelSimpleKafkaResource(KafkaProperties kafkaProperties) {
