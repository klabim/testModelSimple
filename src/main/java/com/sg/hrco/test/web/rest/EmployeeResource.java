...
import com.sg.hrco.test.domain.Employee;
import com.sg.hrco.test.repository.EmployeeRepository;
...
/**
 * REST controller for managing {@link com.sg.hrco.test.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
